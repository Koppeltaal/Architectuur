...
![Gegevensmodel](<.gitbook/assets/resources (2).jpg>)
...
| **Use-case**                                                               | **Interactie**                                                                                   | **Omschrijving**                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>UC-KT-01</p><p>Applicatie registreren</p>                               | -                                                                                                | Applicatie per zorgbehoefte geregistreerd in het Koppeltaal domein. Hier zijn geen interacties tussen systemen voor gedefinieerd, maar moet handmatig door een beheerder (Koppeltaal Support) geconfigureerd worden.                                                          |
| <p>UC-KT-02</p><p>(Sub)activiteiten registreren</p>                        | CreateOrUpdateActivityDefinition                                                                 | Elke interventie moet tenminste één activiteit hebben geregistreerd en kan aangepast danwel uitgebreid worden                                                                                                                                                                 |
| <p>UC-KT-03/</p><p>UC-KT-04/</p><p>UC-KT-09</p><p>Behandelplan starten</p> | CreateOrUpdateCarePlan GetMessage(Headers)                                                       | Na een intake wordt er een behandelplan opgesteld en activiteiten toegekend aan een patiënt. Nadat activiteiten toegekend zijn wordt patiënt genotificeerd via inlogverzoek. Dit behandelplan draagt bij voor een geïntegreerd patiëntenbeeld tussen zorgverlener en patiënt. |
| <p>UC-KT-05</p><p>Interventie lanceren</p>                                 | PostLaunchRequest                                                                                | OAuth 2.0 standaard en SMART-on-FHIR voorschriften.                                                                                                                                                                                                                           |
| <p>UC-KT-06</p><p>Voortgang monitoren</p>                                  | UpdateCarePlanActivityStatus GetMessage(Headers)                                                 | Voortgang en status van een activiteit delen en ontvangen van een interventie. Een interventie is aan een behandelplan gerelateerd.                                                                                                                                           |
| <p>UC-KT-07</p><p>Activiteit evalueren</p>                                 | CreateOrUpdateCarePlanActivityResult GetMessage(Headers)                                         | Uitslagen en resultaten delen en ontvangen van een interventie                                                                                                                                                                                                                |
| <p>UC-KT-08/</p><p>UC-KT-10</p><p>Gebruikers aanmaken</p>                  | CreateOrUpdatePatient CreateOrUpdatePractitioner CreateOrUpdateRelatedPerson GetMessage(Headers) | Verschillende typen gebruikers kunnen worden aangemaakt. Na opvoeren van een gebruiker worden alle geïnteresseerde applicaties gesynchroniseerd en kunnen andere applicaties de gegevens aanvullen.                                                                           |
| <p>UC-KT-11</p><p>Informatie uitwisselen</p>                               | CreateOrUpdateMessage GetMessage(Headers)                                                        | Algemene informatie delen en ontvangen tussen participanten                                                                                                                                                                                                                   |
...
![Informatie uitwisseling](.gitbook/assets/usermessage.jpg)
