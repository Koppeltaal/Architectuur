---
description: >-
  Deze Koppeltaal Architectuur site is bedoeld om vragen te kunnen beantwoorden
  over huidige mogelijkheden, uitbreidingen en beperkingen van functionaliteiten
  van Koppeltaal.
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">HL7 Version 3 Standard www.hl7.org</td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p><a href="http://www.ietf.org">http://www.ietf.org</a>
        </p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        ...
        <p><a href="https://www.w3.org/TR/xml-names/">https://www.w3.org/TR/xml-names/</a>
        </p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Extensible Markup Language (XML) 1.0, W3C Recommendation, Fourth Edition,
          16 August 2007</p>
        <p><a href="https://www.w3.org/TR/xml/">https://www.w3.org/TR/xml/</a>
        </p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">DSTU1 0.0.82</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">The Atom Syndication Format a December 2005 Proposed Standard developed
        by the IETF atompub Working Group. <a href="https://www.w3.org/2005/Atom.htm">https://www.w3.org/2005/Atom.htm</a>
      </td>
      <td style="text-align:left">12 dec 2005</td>
    </tr>
    <tr>
      <td style="text-align:left">Feeds</td>
      <td style="text-align:left">Atom is an XML-based document format that describes lists of related information
    ...
    <tr>
      ...
      <td style="text-align:left">RFC6749 OAuth 2.0 Framework, RFC6750 Bearer Tokens <a href="https://oauth.net/2/">https://oauth.net/2/</a>
      </td>
      <td style="text-align:left">RFC6749, RFC6750</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">A webhook (also called a web callback or HTTP push API) is a way for an
        app to provide other applications with real-time information. See supported
        channel type: rest-hook <a href="http://www.hl7.org/fhir/subscription.html">http://www.hl7.org/fhir/subscription.html</a>
      </td>
      <td style="text-align:left"></td>
    </tr>
  </tbody>
</table>De onderstaande documenten hebben gediend als bron voor dit document:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Verordening 2017/745 Europees Parlement van 5 april 2017</td>
    </tr>
  </tbody>
</table>### Business architectuur

#### Primaire interacties: behandelplan, activiteiten, en workflow

De stichting Koppeltaal heeft als doel een **integratiestandaard** te ontwikkelen, beheren, en implementeren, waarmee interne **gegevensuitwisseling** en **applicatie-integratie** tussen **ICT-systemen** en **eHealth-platformen**\[1\] wordt geregeld bij **zorginstellingen** die diensten voor gedragsverandering en daarmee direct samenhangende diensten verlenen in het algemeen en instellingen voor **Geestelijke Gezondheidszorg** \(GGZ\) in het bijzonder[\[1\]](https://www.koppeltaal.nl/koppeltaalggz/over-stichting-koppeltaal).

Gegevensuitwisseling tussen ICT-systemen en eHealth-platformen via de integratie standaard van de stichting Koppeltaal \(Koppeltaal\) is relevant in de context van **blended care in de GGZ**. Bij blended care in de GGZ worden reguliere face-to-face gesprekken gecombineerd met **online interventies** zoals bijvoorbeeld chat, beeldbellen, **online behandelmodules** en **online inzage in het eigen gezondheidsdossier**[\[2\]](http://www.medmij.nl). Hierdoor kan een cliënt niet alleen tijd, maar ook plaats-onafhankelijk zorg gebruiken via een tablet of smartphone[\[3\]](http://www.ggznederland.nl/themas/e-health).
...
#### Positie van Koppeltaal in het GGZ-referentiedomeinen model[**\[4\]**](https://www.nictiz.nl/standaardisatie/referentiedomeinenmodellen/referentiedomeinmodel-ggz/)\*\*\*\*
...
![Koppeltaal domeinen, applicaties, instanties en beheer](.gitbook/assets/koppeltaal-dom-app-func.png)

#### Beheer rollen en interacties

Om Koppeltaal als dienst aan het hierboven beschreven netwerk ter beschikking te stellen is er interactie tussen de beheer rollen van zorgaanbieders, leveranciers, en stichting Koppeltaal. **Koppeltaal regie** zorgt voor optimale beschikbaarheid van informatie in de **Koppeltaal keten**. Koppeltaal regie wordt gevoerd door VZVZ-servicecentrum. De rol **Koppeltaal ketensupport** zorgt voor de dienstverlening aan alle domeinen en applicaties die aangesloten zijn bij Koppeltaal. Koppeltaal ketensupport wordt op dit moment uitgevoerd door VitalHealth Solutions. De rol **Koppeltaal systeembeheer** is verantwoordelijk voor de algemene systeem administratie van Koppeltaal, zoals de hosting van Koppeltaal en beheer van beheerders. De rol **Koppeltaal domeinbeheer** is de gedelegeerd verantwoordelijke namens een zorgaanbieder voor het domein van de zorgaanbieder. Namens de zorgaanbieder bepaalt de Koppeltaal domeinbeheerder welke applicaties met elkaar informatie in een domein uitwisselen op basis van overeenkomsten tussen de zorgaanbieder en de applicatie-leveranciers. De rol Koppeltaal domeinbeheer is daarnaast verantwoordelijkheid voor de beschikbaarheid van dienstverlening via Koppeltaal voor behandelaars en cliënten in het betreffende domein. De rol van Koppeltaal domeinbeheer wordt uitgevoerd door VitalHealth Solutions onder verantwoordelijkheid van de deelnemende zorgaanbieder. En per applicatie zorgt de rol **Koppeltaal applicatiebeheer** voor de beschikbaarheid van de betreffende applicatie voor de verschillende domeinen waarop deze applicatie is aangesloten. De rol van Koppeltaal applicatiebeheer wordt door VitalHealth Solutions uitgevoerd onder verantwoordelijkheid van de betreffende Koppeltaal IT-deelnemer. Naast de rol Koppeltaal applicatiebeheer bestaat er ook een rol **Koppeltaal instantiebeheer** voor het kunnen inzien van applicaties die gekoppeld zijn aan een applicatie instantie binnen een domein.
...
In de [\[Appendix\]](./#1-3-2-data-toegankelijkheid) is er een Autorisatie matrix voor alle beheer rollen toegevoegd.
...
| **Scenario per stap** | **Use case / functie Koppeltaal** |
| :--- | :--- |
...
<table>
  ...
  <tbody></tbody>
</table>In de specialistische GGZ zou Koppeltaal bijvoorbeeld in het volgende scenario ingezet kunnen worden:
...
| **Koppeltaal usecase** | **Koppeltaal bericht type** |
| :--- | :--- |
...
Aan elke applicatie wordt een unieke FHIR-basis URL toegewezen, welke de basis vormt voor de aanmaak van resource URLs, bijvoorbeeld “[https://xxx.eengeregistreerdenaam.nl/fhir”](https://xxx.eengeregistreerdenaam.nl/fhir”).
...
[https://xxx.jouwomgeving.nl/fhir/Patient/32324/\_history/812909](https://xxx.jouwomgeving.nl/fhir/Patient/32324/_history/812909)
...
1. De applicaties gebruiken HTTP calls om berichten te sturen: het POST van het bericht bundel zal naar de kern Koppeltaal inbox gaan: [https://koppeltaal.nl/FHIR/Koppeltaal/Mailbox](https://koppeltaal.nl/FHIR/Koppeltaal/Mailbox).
...
API URL: [https://koppeltaal.nl/FHIR/Koppeltaal/MessageHeader/\[id\](https://koppeltaal.nl/FHIR/Koppeltaal/MessageHeader/[id\)\] \(dit is de URL geretourneerd als id link in het MessageHeader bundle\)
...
Om gegevens op te slaan, of op te halen kan het eindpunt [https://koppeltaal.nl/FHIR/Koppeltaal/Other?code=StorageItem](https://koppeltaal.nl/FHIR/Koppeltaal/Other?code=StorageItem) worden gebruikt. De header bevat username password en koppelt het bericht aan een application instance. De volgende operaties worden ondersteund:
...
Activity Definities kunnen worden gelezen met een specifieke GET REST API: [https://koppeltaal.nl/FHIR/Koppeltaal/Other/\_search?code=ActivityDefinition&\[includearchived=yes\](https://koppeltaal.nl/FHIR/Koppeltaal/Other/_search?code=ActivityDefinition&[includearchived=yes\)\].
...
| Resource | FHIR hanteert de definitie Resource \(lijst met mogelijke Resources: [https://www.hl7.org/fhir/resourcelist.html\](https://www.hl7.org/fhir/resourcelist.html\)\) | Gegevensbron |
...
&lt;link rel="self" href="[http://co.healthonline.nl/Patient/215325/\_history/2018-07-11T08:01:22:181.2659](http://co.healthonline.nl/Patient/215325/_history/2018-07-11T08:01:22:181.2659)" /&gt;

&lt;content type="text/xml"&gt;

&lt;Patient id="215325" xmlns="[http://hl7.org/fhir"&gt](http://hl7.org/fhir"&gt);
...
&lt;feed xmlns="[http://www.w3.org/2005/Atom"&gt](http://www.w3.org/2005/Atom"&gt);

&lt;id&gt;urn:uuid:5931e3dc-243b-4f29-9200-78c238df9771&lt;/id&gt;

&lt;category term="[http://ggz.koppeltaal.nl/fhir/Koppeltaal/Domain\#Dev](http://ggz.koppeltaal.nl/fhir/Koppeltaal/Domain#Dev)" label="Dev" scheme="[http://hl7.org/fhir/tag/security"/&gt](http://hl7.org/fhir/tag/security"/&gt);

&lt;category term="[http://hl7.org/fhir/tag/message](http://hl7.org/fhir/tag/message)" scheme="[http://hl7.org/fhir/tag"/&gt](http://hl7.org/fhir/tag"/&gt);
...
&lt;MessageHeader xmlns="[http://hl7.org/fhir"&gt](http://hl7.org/fhir"&gt);
...
&lt;OperationOutcome xmlns="[http://hl7.org/fhir"&gt](http://hl7.org/fhir"&gt);

&lt;text&gt;

&lt;status value="generated"/&gt;

&lt;div xmlns="[http://www.w3.org/1999/xhtml"&gt](http://www.w3.org/1999/xhtml"&gt);
...
&lt;system value="[http://hl7.org/fhir/issue-type"/&gt](http://hl7.org/fhir/issue-type"/&gt);

&lt;code value="conflict"/&gt;

&lt;/type&gt;

&lt;extension url="[http://ggz.koppeltaal.nl/fhir/Koppeltaal/OperationOutcome\#IssueResource"&gt](http://ggz.koppeltaal.nl/fhir/Koppeltaal/OperationOutcome#IssueResource"&gt);
...
| **Event.code\[1\]** | **Definitie** | **FHIR Resource entries** |
| :--- | :--- | :--- |
...
<table>
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdatePatient</th>
      <th style="text-align:left">Clienten aanmaken of aanpassen tussen applicaties in &#xE9;&#xE9;n domein</th>
      <th
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdatePractitioner</th>
      <th style="text-align:left">Behandelaars aanmaken of aanpassen tussen applicaties in &#xE9;&#xE9;n
        domein</th>
      <th style="text-align:left">
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdateRelatedPerson</th>
      <th style="text-align:left">Derden (familie gerelateerden) aanmaken of aanpassen tussen applicaties
        in &#xE9;&#xE9;n domein</th>
      <th style="text-align:left">
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdateActivityDefinition</th>
      <th style="text-align:left">(Sub)activiteiten publiceren voor gebruik in andere applicaties in het
        domein</th>
      <th style="text-align:left">
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdateCarePlan</th>
      <th style="text-align:left">(Sub)activiteiten uit applicaties toekennen aan een gebruiker (Patient,
  ...
  <thead>
    <tr>
      <th style="text-align:left">UpdateCarePlanActivityStatus</th>
      <th style="text-align:left">Voortgang- en statusberichten van (sub)activiteiten delen en ontvangen</th>
      <th
      style="text-align:left">
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdateCarePlanActivityResult</th>
      <th style="text-align:left">Resultaatberichten van (sub)activiteiten delen en ontvangen</th>
      <th style="text-align:left">
  ...
  <thead>
    <tr>
      <th style="text-align:left">CreateOrUpdateUserMessage</th>
      <th style="text-align:left">Algemene gebruikersberichten delen en ontvangen</th>
      <th style="text-align:left">
...
| Type |  |
| **feed.entry.content** |  |
| Definition | Contains or links to the content of the entry. The content is FHIR Resource specific and uses FHIR namespace \(“[http://hl7.org/fhir\](http://hl7.org/fhir\)\) to define the FHR Resource |
| Control |  |
| Type |  |
| **feed.entry.summary** |  |
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:left"><a href="https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#MessageEvents">MessageEvents</a>
        <br
...
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#Patient](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#Patient) |
| :--- | :--- |
...
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#ProcessingStatus](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#ProcessingStatus) |
| :--- | :--- |
...
| Binding | [ProcessingStatus](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#ProcessingStatus) |
| :--- | :--- |


| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#ProcessingStatusStatus](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#ProcessingStatusStatus) |
| :--- | :--- |
...
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#ProcessingStatusStatusLastChanged](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#ProcessingStatusStatusLastChanged) |
| :--- | :--- |
...
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#ProcessingStatusException](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#ProcessingStatusException) |
| :--- | :--- |
...
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader\#IsExpired](http://ggz.koppeltaal.nl/fhir/Koppeltaal/MessageHeader#IsExpired) |
| :--- | :--- |
...
| Binding | [CarePlanActivityResultStatus](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#CarePlanActivityResultStatus) |
| :--- | :--- |
...
| Resource | Resource\([Organization](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#Organization)\) |
| :--- | :--- |
...
| Type | Resource\([Observation](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#h.x3jvacdqju92)\) |
| :--- | :--- |
...
| Extension | http://ggz.koppeltaal.nl/fhir/Koppeltaal/CarePlanActivityResult\#Questionnaire |
| :--- | :--- |


| Type | Resource\([Questionnaire](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#h.w2jukt6b7sm7)\) |
| :--- | :--- |
...
| Comments | All known identifiers shall be given. A typical identifier for an organization is the AGB code. If no other identifier is known, a system specific identifier can be given. \(See [Identifiers](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#h.p09w0b53b6hw) for information on formatting.\) |
| :--- | :--- |
...
| Definition | Contact details \(telephone, email, etc\) |
| :--- | :--- |
...
| Definition | Visiting or postal address for the contact |
| :--- | :--- |
...
| Control | 1..1 |
| Type | Code |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#ContentType](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#ContentType) |
| **StorageItem.content** |  |
| Definition | The actual content, base64 encoded. |
| Control | 1..1 |
| Type | base64Binary |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#Content](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#Content) |
| **StorageItem.PatientIdentifier** |  |
| Definition | The Patient in whose context this data belongs. |
| Control | 1..1 |
| Type | Resource\([Patient](https://support.koppeltaal.nl/resources/42-koppeltaal-api-1-3#Patient)\) |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#PatientIdentifier](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#PatientIdentifier) |
| **StorageItem.objectType** |  |
| Definition | The type of the object being stored. |
| Control | 1..1 |
| Type | String |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#ObjectType](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#ObjectType) |
...
| Control | 1..1 |
| Type | String |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#ObjectKey](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#ObjectKey) |
| **StorageItem.lastModified** |  |
| Definition | The instant this object was last modified. |
| Control | 1..1 |
| Type | Instant |
| Extension | [http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem\#LastModified](http://ggz.koppeltaal.nl/fhir/Koppeltaal/StorageItem#LastModified) |
