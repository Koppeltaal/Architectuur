...
| Control | 0..1 |
| Binding | PatientRelationshipType: \(see [http://hl7.org/fhir/DSTU1/valueset-relatedperson-relationshiptype.html](http://hl7.org/fhir/DSTU1/valueset-relatedperson-relationshiptype.html)\) |
| Type | CodeableConcept |
| **RelatedPerson.name** |  |
| Definition | A name associated with the person. |
| Control | 0..1 |
